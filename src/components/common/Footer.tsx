  ...
  return (
    <footer className="bg-apple-gray-600 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-apple-gray-300 leading-relaxed">
              Frontend Developer passionate about creating beautiful, responsive user interfaces 
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-4">
                ...
                className="w-10 h-10 bg-apple-gray-500 rounded-full flex items-center justify-center hover:bg-apple-blue transition-colors duration-200"
              >
        ...
        <div className="border-t border-apple-gray-500 mt-8 pt-8 text-center">
          <p className="text-apple-gray-300">
