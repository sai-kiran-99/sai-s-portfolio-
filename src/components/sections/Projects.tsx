      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <AnimatedSection delay={500}>
          <div className="text-center">
            <div className="bg-apple-gray-50 rounded-3xl p-8 sm:p-12">
              <h3 className="text-2xl font-bold text-apple-gray-600 mb-4">
                More Projects Coming Soon
              </h3>
              <p className="text-lg text-apple-gray-500 mb-6 max-w-2xl mx-auto">
              ...
              <a
                ...
                className="inline-flex items-center px-6 py-3 bg-apple-blue text-white font-semibold rounded-full hover:bg-blue-600 transition-colors duration-200"
              >
